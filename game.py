...
class Game:
    ...
    # Пустые клетки рендерим квадратами — у '·' и unicode-фигур разная
    # ширина в пропорциональном шрифте карточки Алисы, поэтому колонки
    # доски «плыли». Квадраты (□/▫) визуально ближе к фигурам по ширине.
    _EMPTY_SQUARE = '□'
